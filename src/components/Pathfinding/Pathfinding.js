...
class Pathfinding extends Component{
    ...
    makeGrid=()=>{
        ...
        let row_size=Math.floor((window.innerHeight-60)/33);
        let col_size=Math.floor((window.innerWidth)/33);
        let arr=[]
                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style={{color:"white"}}>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <li className="nav-item" style={{marginLeft:"10px",minWidth:"120px"}} >
                            <p className="progress-text" style={{color: "gold"}}><span className="span-text">Visited Nodes</span>
                        ...
                        <li className="nav-item" style={{marginLeft:"10px",minWidth:"120px"}}>
                            <p className="progress-text" style={{color: "lightgreen"}}><span className="span-text">Shortest Path</span>
