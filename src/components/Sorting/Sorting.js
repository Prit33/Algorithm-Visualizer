...
class Sorting extends Component{
    ...
    createArray=(e=Math.floor(window.innerWidth/50)/2)=>{
        ...
        for(let i=0;i<e;i++){
            arr.push({
                value:Math.floor(Math.random() * ((window.innerHeight/4)-30+1))+30,         //random values
                id:"id-"+i
            })
        }
        this.setState({
            ...
            <div>
                        ...
                        <li class="nav-item dropdown" >
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown" >
                                <li class="ml-3 nav-item">
                                    ...
                                    <a class="nav-link" style={{color: "black",fontSize:"12px"}}>Increase Array Size</a>
                                </li>
                                <li class="ml-3 nav-item">
                                    <input onChange={this.changeSpeed} type="range" min="100" max={1000} defaultValue={500} id="changeSize"/>
                                    <a class="nav-link" style={{color: "black",fontSize:"12px"}}>Increase Speed</a>
                                </li>
                            </div>
                        </li>
              ...
              <div className="bars" id="bars" style={{margin:"20px"}}>
                    ...
                    <motion.div
                        ...
                        id={element.id}
                        style={{height:element.value*3,order:index,borderRadius: '8px'}}
                    >
